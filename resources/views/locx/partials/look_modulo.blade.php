<div class="look-page">
    <section class="look-hero">
        ...
        <div class="look-hero-mark">{!! \App\Support\Locx::icon($page) !!}</div>
    </section>
            ...
            <table>
                ...
                @forelse($lookRegistros as $registro)
                    <tr>
                        ...
                        <td>{{ \App\Support\Locx::moeda($registro->valor) }}</td>
                        <td>{{ $registro->vencimento?->format('d/m/Y') ?? '-' }}</td>
                        <td>{!! \App\Support\Locx::status($registro->status) !!}</td>
        ...
        <div class="panel">
            ...
            <div class="look-shortcuts">
                @forelse($lookRelacionados as $modulo)
                    <a class="module-card" href="{{ route('locx.index', ['page' => $modulo]) }}">
                        <i>{!! \App\Support\Locx::icon($modulo) !!}</i>
                        <div>
